...
#ifndef BULLDOZER_NAVIGATE_THROUGH_POSES_HPP
#define BULLDOZER_NAVIGATE_THROUGH_POSES_HPP
...
class BulldozerNavigateThroughPoses : public rclcpp::Node
{
public:
