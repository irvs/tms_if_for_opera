...
#ifndef BULLDOZER_NAVIGATE_THROUGH_POSES_DEG_HPP
#define BULLDOZER_NAVIGATE_THROUGH_POSES_DEG_HPP
...
class BulldozerNavigateThroughPosesDeg : public rclcpp::Node
{
public:
    ...
    BulldozerNavigateThroughPosesDeg();
