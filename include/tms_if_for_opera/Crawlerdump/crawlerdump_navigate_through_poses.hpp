...
#ifndef CRAWLERDUMP_NAVIGATE_THROUGH_POSES_HPP
#define CRAWLERDUMP_NAVIGATE_THROUGH_POSES_HPP
...
class CrawlerdumpNavigateThroughPoses : public rclcpp::Node
{
public:
    ...
    CrawlerdumpNavigateThroughPoses();
