...
#ifndef CRAWLERDUMP_NAVIGATE_THROUGH_POSES_DEG_HPP
#define CRAWLERDUMP_NAVIGATE_THROUGH_POSES_DEG_HPP
...
class CrawlerdumpNavigateThroughPosesDeg : public rclcpp::Node
{
public:
    ...
    CrawlerdumpNavigateThroughPosesDeg();
