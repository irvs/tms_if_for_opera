...
#ifndef EXCAVATOR_NAVIGATE_THROUGH_POSES_HPP
#define EXCAVATOR_NAVIGATE_THROUGH_POSES_HPP
...
class ExcavatorNavigateThroughPoses : public rclcpp::Node
{
public:
