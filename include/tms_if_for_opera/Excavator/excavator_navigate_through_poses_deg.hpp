...
#ifndef EXCAVATOR_NAVIGATE_THROUGH_POSES_DEG_HPP
#define EXCAVATOR_NAVIGATE_THROUGH_POSES_DEG_HPP
...
class ExcavatorNavigateThroughPosesDeg : public rclcpp::Node
{
public:
    ...
    ExcavatorNavigateThroughPosesDeg();
