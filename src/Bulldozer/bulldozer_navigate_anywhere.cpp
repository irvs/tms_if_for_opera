...
#include <vector>
#include "tms_if_for_opera/Bulldozer/bulldozer_navigate_anywhere.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

BulldozerNavigateAnywhere::BulldozerNavigateAnywhere() : rclcpp::Node("tms_if_navigate_anywhere_node")
{
    this->action_server_ = rclcpp_action::create_server<NavigateToPose>(
        this, "tms_rp_navigate_anywhere",
        std::bind(&BulldozerNavigateAnywhere::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&BulldozerNavigateAnywhere::handle_cancel, this, std::placeholders::_1),
        std::bind(&BulldozerNavigateAnywhere::handle_accepted, this, std::placeholders::_1));

    
    action_client_ = rclcpp_action::create_client<NavigateToPose>(this, "navigate_to_pose");
}

rclcpp_action::GoalResponse BulldozerNavigateAnywhere::handle_goal(
...
rclcpp_action::CancelResponse BulldozerNavigateAnywhere::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void BulldozerNavigateAnywhere::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&BulldozerNavigateAnywhere::execute, this, _1), goal_handle }.detach();
}

void BulldozerNavigateAnywhere::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void BulldozerNavigateAnywhere::goal_response_callback(const GoalHandleNavigateToPose::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void BulldozerNavigateAnywhere::feedback_callback(
...
//result
void BulldozerNavigateAnywhere::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<BulldozerNavigateAnywhere>());
    rclcpp::shutdown();
    return 0;
}
