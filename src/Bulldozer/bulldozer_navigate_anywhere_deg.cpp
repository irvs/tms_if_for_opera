...
#include <vector>
#include "tms_if_for_opera/Bulldozer/bulldozer_navigate_anywhere_deg.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

BulldozerNavigateAnywhereDeg::BulldozerNavigateAnywhereDeg() : rclcpp::Node("tms_if_navigate_anywhere_deg_node")
{
    this->action_server_ = rclcpp_action::create_server<NavigateToPose>(
        this, "tms_rp_navigate_anywhere_deg",
        std::bind(&BulldozerNavigateAnywhereDeg::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&BulldozerNavigateAnywhereDeg::handle_cancel, this, std::placeholders::_1),
        std::bind(&BulldozerNavigateAnywhereDeg::handle_accepted, this, std::placeholders::_1));

    
    action_client_ = rclcpp_action::create_client<NavigateToPose>(this, "navigate_to_pose");
}

rclcpp_action::GoalResponse BulldozerNavigateAnywhereDeg::handle_goal(
...
rclcpp_action::CancelResponse BulldozerNavigateAnywhereDeg::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void BulldozerNavigateAnywhereDeg::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&BulldozerNavigateAnywhereDeg::execute, this, _1), goal_handle }.detach();
}

void BulldozerNavigateAnywhereDeg::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void BulldozerNavigateAnywhereDeg::goal_response_callback(const GoalHandleNavigateToPose::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void BulldozerNavigateAnywhereDeg::feedback_callback(
...
//result
void BulldozerNavigateAnywhereDeg::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<BulldozerNavigateAnywhereDeg>());
    rclcpp::shutdown();
    return 0;
}
