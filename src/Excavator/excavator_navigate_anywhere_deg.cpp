...
#include <vector>
#include "tms_if_for_opera/Excavator/excavator_navigate_anywhere_deg.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

ExcavatorNavigateAnywhereDeg::ExcavatorNavigateAnywhereDeg() : rclcpp::Node("tms_if_navigate_anywhere_deg_node")
{
    this->action_server_ = rclcpp_action::create_server<NavigateToPose>(
        this, "tms_rp_navigate_anywhere_deg",
        std::bind(&ExcavatorNavigateAnywhereDeg::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&ExcavatorNavigateAnywhereDeg::handle_cancel, this, std::placeholders::_1),
        std::bind(&ExcavatorNavigateAnywhereDeg::handle_accepted, this, std::placeholders::_1));

    
    action_client_ = rclcpp_action::create_client<NavigateToPose>(this, "navigate_to_pose");
}

rclcpp_action::GoalResponse ExcavatorNavigateAnywhereDeg::handle_goal(
...
rclcpp_action::CancelResponse ExcavatorNavigateAnywhereDeg::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void ExcavatorNavigateAnywhereDeg::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&ExcavatorNavigateAnywhereDeg::execute, this, _1), goal_handle }.detach();
}

void ExcavatorNavigateAnywhereDeg::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void ExcavatorNavigateAnywhereDeg::goal_response_callback(const GoalHandleNavigateToPose::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void ExcavatorNavigateAnywhereDeg::feedback_callback(
...
//result
void ExcavatorNavigateAnywhereDeg::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<ExcavatorNavigateAnywhereDeg>());
    rclcpp::shutdown();
    return 0;
}
