...
ExcavatorNavigateThroughPosesDeg::ExcavatorNavigateThroughPosesDeg() : rclcpp::Node("tms_if_navigate_through_poses_deg_node")
{
    this->action_server_ = rclcpp_action::create_server<NavigateThroughPoses>(
        this, "tms_rp_navigate_through_poses_deg",
        std::bind(&ExcavatorNavigateThroughPosesDeg::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&ExcavatorNavigateThroughPosesDeg::handle_cancel, this, std::placeholders::_1),
        std::bind(&ExcavatorNavigateThroughPosesDeg::handle_accepted, this, std::placeholders::_1));

    
    action_client_ = rclcpp_action::create_client<NavigateThroughPoses>(this, "navigate_through_poses");
}

rclcpp_action::GoalResponse ExcavatorNavigateThroughPosesDeg::handle_goal(
...
rclcpp_action::CancelResponse ExcavatorNavigateThroughPosesDeg::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void ExcavatorNavigateThroughPosesDeg::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&ExcavatorNavigateThroughPosesDeg::execute, this, _1), goal_handle }.detach();
}

void ExcavatorNavigateThroughPosesDeg::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void ExcavatorNavigateThroughPosesDeg::goal_response_callback(const GoalHandleNavigateThroughPoses::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void ExcavatorNavigateThroughPosesDeg::feedback_callback(
...
//result
void ExcavatorNavigateThroughPosesDeg::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<ExcavatorNavigateThroughPosesDeg>());
    rclcpp::shutdown();
    return 0;
}
