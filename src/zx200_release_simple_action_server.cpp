...
void Zx200ReleaseSimpleActionServer::apply_collision_objects_from_robot_description_and_tf(
...
bool Zx200ReleaseSimpleActionServer::load_urdf_from_file(const std::string& robot_name)
{
  try {
